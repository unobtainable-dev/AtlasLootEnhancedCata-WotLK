...
function AtlasLoot:OnLoaderLoad()
	...
	if((AtlasLootCharDB.AtlasLootVersion == nil) or (tonumber(AtlasLootCharDB.AtlasLootVersion) < tonumber(VERSION_MAJOR..VERSION_MINOR..VERSION_BOSSES))) then
		...
		-- AtlasLootCharDB.AutoQuery = true;
	end
...
_G["AtlasLoot_SetItemInfoFrame"] = function(...)
    if AtlasLoot.SetItemInfoFrame then
        -- pFrame is passed automatically via ...
        return AtlasLoot:SetItemInfoFrame(...)
    end
end
