...
do
	...
	function AtlasLoot:CreateAtlasLootPanel()
		...
		Frame:SetPoint("CENTER", "UIParent", "BOTTOM", 0, 0)
		...
		SearchFrame.SearchBox:SetPoint("BOTTOMLEFT", SearchFrame, "BOTTOMLEFT", 0, -15)
		SearchFrame.SearchBox:SetWidth(250)
		SearchFrame.SearchBox:SetHeight(25)
		...
		SearchFrame.SearchSelectModule = AtlasLoot:CreateSearchModuleDropDown(SearchFrame, {"LEFT", SearchFrame.Search, "RIGHT", 0, 0}, "AtlasLootPanelSearch_SelectModule")
		--[[				
