...
--[[			{ 16, 18703, "", "=q4=Ancient Petrified Leaf", "=ds=#m2# =q1=(#c2#)", "", "35.25%"};
	...
	AtlasLoot_Data["DeadminesGreenskin"] = {
		["Normal"] = {
			{
				{ 2, 5201, "", "=q3=Emberstone Staff", "=ds=#w9#", "" };
				{ 3, 5200, "", "=q3=Impaling Harpoon", "=ds=#w7#", "" };
				{ 4, 10403, "", "=q3=Blackened Defias Belt", "=ds=#s10#", "" };
			};
		};
		info = {
			name = AtlasLoot:EJ_GetBossName("\"Captain\" Greenskin", 93),
			module = moduleName, instance = "TheDeadminesEaI",
		};
	};
...
--	};
	...
	AtlasLoot_Data["ZGJinxedHoodooPile"] = {
		["Normal"] = {
			{
